...
code_bytes_t* code_get(const char* executable_file) {
  ...
  char* executable_filename_0 = (char*) malloc(sizeof(char)
      * hex_filename_length);
  char* executable_filename_1 = (char*) malloc(sizeof(char)
      * hex_filename_length);
  char* executable_filename_2 = (char*) malloc(sizeof(char)
      * hex_filename_length);
  char* executable_filename_3 = (char*) malloc(sizeof(char)
      * hex_filename_length);
  ...
  if (abort) {
    kernel_error(FILE_UNKNOWN,
                 "Cannot open hex files for execution. One or more files doesn't exist");
  } else {
